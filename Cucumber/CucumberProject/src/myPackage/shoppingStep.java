...
public class shoppingStep {
	...
	@And("^I \"([a-zA-Z]{1,})\" buy any item$")
	public void I_cannot_buy_any_item(String data){
		System.out.println("I "+data+" buy any item>>>>");
	}
	...
	public void my_basket_should_not_be_empty(){
		System.out.println("my basket should not be empty <<<<<<<");
	} 
